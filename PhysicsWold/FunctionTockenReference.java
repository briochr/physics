public class FunctionTockenReference {
	...
	public static final int VARX = 13;
	public static final int VARY = 14;
	public static final int VARZ = 15;
	public static final int VALUE = 16;
	public static final int LEFT_BRACKET = 17;
	public static final int RIGHT_BRACKET = 18;

    public static final int SIGMOID = 19;
